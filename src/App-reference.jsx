...
import { UsernameNFTManager } from './platform-sdk';
...
function App() {
  ...
  const usernameNFT = useRef(new UsernameNFTManager('testnet'));

  const featuredGames = [
    {
      id: 1,
      title: "👻 Spooky Slots - PLAY NOW!",
      image: "https://picsum.photos/seed/slots11/600/400",
      players: "19.3K",
      earnings: "3,450 XLM",
      rating: 4.9,
      category: "Casino",
      isPlayable: true,
      demoUrl: "/spooky-slots-demo.html"
    },
    {
      id: 2,
      title: "Haunted Mansion",
      image: "https://picsum.photos/seed/haunted1/600/400",
      players: "12.4K",
      earnings: "2,450 XLM",
      rating: 4.8,
      category: "Horror"
    ...
    {
      id: 2,
      title: "Pumpkin Racers",
      image: "https://picsum.photos/seed/pumpkin2/600/400",
      players: "8.2K",
      earnings: "1,890 XLM",
      rating: 4.6,
      category: "Racing"
    },
    {
      id: 3,
      title: "Witch's Coven",
      image: "https://picsum.photos/seed/witch3/600/400",
      players: "15.7K",
      earnings: "3,200 XLM",
      rating: 4.9,
      category: "RPG"
    },
    {
      ...
      image: "https://picsum.photos/seed/zombie4/600/400",
      players: "6.5K",
      earnings: "1,450 XLM",
      rating: 4.5,
      category: "Survival"
    },
    {
      id: 5,
      title: "Vampire Arena",
      image: "https://picsum.photos/seed/vampire5/600/400",
      players: "10.1K",
      earnings: "2,100 XLM",
      rating: 4.7,
      category: "Battle"
    ...
    {
      id: 6,
      title: "Graveyard Tycoon",
      image: "https://picsum.photos/seed/graveyard6/600/400",
      players: "9.3K",
      earnings: "1,780 XLM",
      rating: 4.6,
      category: "Strategy"
    },
    {
      id: 7,
      title: "Ghost Hunter",
      image: "https://picsum.photos/seed/ghost7/600/400",
      players: "11.2K",
      earnings: "2,230 XLM",
      rating: 4.7,
      category: "Action"
    },
    {
      id: 8,
      title: "Cursed Castle",
      image: "https://picsum.photos/seed/castle8/600/400",
      players: "14.6K",
      earnings: "2,890 XLM",
      rating: 4.8,
      category: "Adventure"
    },
    {
      ...
      image: "https://picsum.photos/seed/monster9/600/400",
      players: "7.8K",
      earnings: "1,650 XLM",
      rating: 4.4,
      category: "Arcade"
    ...
    {
      id: 10,
      title: "Necromancer's Quest",
      image: "https://picsum.photos/seed/necro10/600/400",
      players: "13.1K",
      earnings: "2,750 XLM",
      rating: 4.9,
      category: "RPG"
    ...
    {
      id: 12,
      title: "Phantom Racing",
      image: "https://picsum.photos/seed/phantom12/600/400",
      players: "16.5K",
      earnings: "3,120 XLM",
      rating: 4.8,
      category: "Racing"
    ...
    {
      id: 13,
      title: "Werewolf Woods",
      image: "https://picsum.photos/seed/werewolf13/600/400",
      players: "9.7K",
      earnings: "2,050 XLM",
      rating: 4.6,
      category: "Horror"
    ...
    {
      id: 14,
      title: "Skeleton Showdown",
      image: "https://picsum.photos/seed/skeleton14/600/400",
      players: "11.3K",
      earnings: "2,340 XLM",
      rating: 4.7,
      category: "Battle"
    },
    {
      id: 15,
      title: "Dark Dungeon",
      image: "https://picsum.photos/seed/dungeon15/600/400",
      players: "13.8K",
      earnings: "2,890 XLM",
      rating: 4.8,
      category: "Adventure"
    },
    {
      id: 16,
      title: "Potion Master",
      image: "https://picsum.photos/seed/potion16/600/400",
      players: "8.4K",
      earnings: "1,760 XLM",
      rating: 4.5,
      category: "Puzzle"
    },
    {
      id: 17,
      title: "Demon Slayer",
      image: "https://picsum.photos/seed/demon17/600/400",
      players: "15.2K",
      earnings: "3,150 XLM",
      rating: 4.9,
      category: "Action"
    },
    {
      id: 18,
      title: "Cryptid Hunt",
      image: "https://picsum.photos/seed/cryptid18/600/400",
      players: "10.6K",
      earnings: "2,230 XLM",
      rating: 4.6,
      category: "Adventure"
    },
    {
      id: 19,
      title: "Haunted Heist",
      image: "https://picsum.photos/seed/heist19/600/400",
      players: "12.9K",
      earnings: "2,680 XLM",
      rating: 4.7,
      category: "Strategy"
    ...
    {
      id: 20,
      title: "Spectral Siege",
      image: "https://picsum.photos/seed/spectral20/600/400",
      players: "14.1K",
      earnings: "2,950 XLM",
      rating: 4.8,
    ...
    },
    {
      id: 21,
      title: "Voodoo Valley",
      image: "https://picsum.photos/seed/voodoo21/600/400",
      players: "9.1K",
      earnings: "1,920 XLM",
      rating: 4.5,
      category: "RPG"
    },
    {
      ...
      image: "https://picsum.photos/seed/market22/600/400",
      players: "17.3K",
      earnings: "3,420 XLM",
      rating: 4.8,
      category: "Trading"
    },
    {
      id: 23,
      title: "Ghoul Rush",
      image: "https://picsum.photos/seed/ghoul23/600/400",
      players: "8.7K",
      earnings: "1,830 XLM",
      rating: 4.4,
      category: "Arcade"
    },
    {
      id: 24,
      title: "Shadow Realm",
      image: "https://picsum.photos/seed/shadow24/600/400",
      players: "13.5K",
      earnings: "2,810 XLM",
      rating: 4.9,
      category: "RPG"
    },
    {
      id: 25,
      title: "Banshee Bingo",
      image: "https://picsum.photos/seed/banshee25/600/400",
      players: "18.2K",
      earnings: "3,380 XLM",
      rating: 4.6,
      category: "Casino"
    ...
    {
      id: 26,
      title: "Poltergeist Party",
      image: "https://picsum.photos/seed/poltergeist26/600/400",
      players: "11.8K",
      earnings: "2,470 XLM",
      rating: 4.7,
      category: "Party"
    },
    {
      id: 27,
      title: "Reaper's Race",
      image: "https://picsum.photos/seed/reaper27/600/400",
      players: "15.9K",
      earnings: "3,210 XLM",
      rating: 4.8,
      category: "Racing"
    },
    {
      ...
      image: "https://picsum.photos/seed/carnival28/600/400",
      players: "10.2K",
      earnings: "2,140 XLM",
      rating: 4.5,
      category: "Adventure"
    ...
    {
      id: 29,
      title: "Occult Origins",
      image: "https://picsum.photos/seed/occult29/600/400",
      players: "12.4K",
      earnings: "2,590 XLM",
      rating: 4.7,
      category: "RPG"
    },
    {
      ...
      image: "https://picsum.photos/seed/nightmare30/600/400",
      players: "16.7K",
      earnings: "3,290 XLM",
      rating: 4.9,
      category: "Horror"
    ...
    {
      id: 31,
      title: "Gargoyle Gardens",
      image: "https://picsum.photos/seed/gargoyle31/600/400",
      players: "9.5K",
      earnings: "1,990 XLM",
      rating: 4.6,
      category: "Simulation"
    },
    {
      id: 32,
      title: "Spellbound",
      image: "https://picsum.photos/seed/spellbound32/600/400",
      players: "14.3K",
      earnings: "2,980 XLM",
      rating: 4.8,
      category: "Puzzle"
    ...
    {
      id: 33,
      title: "Bone Yard Brawl",
      image: "https://picsum.photos/seed/boneyard33/600/400",
      players: "11.1K",
      earnings: "2,310 XLM",
      rating: 4.7,
      category: "Battle"
    },
    {
      id: 34,
      title: "Mystic Manor",
      image: "https://picsum.photos/seed/mystic34/600/400",
      players: "13.2K",
      earnings: "2,740 XLM",
      rating: 4.8,
      category: "Adventure"
    },
    {
      ...
      image: "https://picsum.photos/seed/undead35/600/400",
      players: "17.6K",
      earnings: "3,510 XLM",
      rating: 4.9,
      category: "Survival"
    ...
    {
      id: 36,
      title: "Cauldron Clash",
      image: "https://picsum.photos/seed/cauldron36/600/400",
      players: "8.9K",
      earnings: "1,870 XLM",
      rating: 4.5,
      category: "Strategy"
  ...
  const stats = [
    { icon: Users, label: "Haunted Players", value: "2.4M+", color: "from-orange-500 to-red-600" },
    { icon: Gamepad2, label: "Spooky Games", value: "450+", color: "from-purple-500 to-pink-600" },
    { icon: TrendingUp, label: "Total Souls", value: "1.2M XLM", color: "from-green-500 to-emerald-600" },
    { icon: Skull, label: "Cursed NFTs", value: "666", color: "from-red-500 to-orange-600" }
  ];

  // Get unique categories for filter
  const categories = ['All', ...new Set(featuredGames.map(game => game.category))];
  ...
  const loadUsernameFromChain = async () => {
    ...
    try {
      const fetchedUsername = await usernameNFT.current.getUsername(walletAddress);
      if (fetchedUsername) {
        setUsername(fetchedUsername);
        console.log('✅ Loaded username from blockchain:', fetchedUsername);
      } else {
        setUsername('');
        console.log('ℹ️ No username NFT found for this address');
      }
    } catch (error) {
  ...
  const saveUsername = async () => {
    ...
    try {
      ...
      if (existingUsername) {
        ...
        const result = await usernameNFT.current.changeUsername(tempUsername, walletAddress);
        ...
        const result = await usernameNFT.current.claimUsername(tempUsername, walletAddress);
        
        if (result.success) {
          setUsername(result.username);
          setIsEditingUsername(false);
          setTempUsername('');
          alert(`✅ Username "${result.username}" claimed as NFT! Transaction: ${result.hash.substring(0, 8)}...`);
        }
      }
    } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-[#050608] relative">
      ...
      <div ref={mainContentRef} className="min-h-screen bg-gradient-to-b from-[#050608] via-orange-950/20 to-[#050608] pt-24 pb-20 relative overflow-hidden">
        {/* Floating Background Icons - Bouncing DVD Style */}
        <div className="absolute inset-0 pointer-events-none opacity-[0.05]">
          <Skull className="absolute top-20 left-[10%] w-16 h-16 text-orange-500 animate-bounce1" />
          <Flame className="absolute top-40 right-[15%] w-12 h-12 text-orange-500 animate-bounce2" />
          <Skull className="absolute top-[60%] left-[20%] w-20 h-20 text-purple-500 animate-bounce3" />
          <Flame className="absolute top-[30%] right-[30%] w-14 h-14 text-red-500 animate-bounce4" />
          <Skull className="absolute bottom-40 right-[10%] w-16 h-16 text-orange-500 animate-bounce5" />
          <Flame className="absolute bottom-60 left-[25%] w-12 h-12 text-purple-500 animate-bounce6" />
          <Skull className="absolute top-[45%] right-[5%] w-18 h-18 text-red-500 animate-bounce1" style={{animationDelay: '3s'}} />
          <Flame className="absolute bottom-32 right-[35%] w-16 h-16 text-orange-500 animate-bounce2" style={{animationDelay: '5s'}} />
          <Skull className="absolute top-[25%] left-[5%] w-14 h-14 text-orange-500 animate-bounce3" style={{animationDelay: '2s'}} />
          <Flame className="absolute top-[70%] right-[20%] w-10 h-10 text-purple-500 animate-bounce4" style={{animationDelay: '4s'}} />
          <Skull className="absolute top-[15%] right-[40%] w-12 h-12 text-red-500 animate-bounce5" style={{animationDelay: '6s'}} />
          <Flame className="absolute bottom-20 left-[15%] w-16 h-16 text-orange-500 animate-bounce6" style={{animationDelay: '1s'}} />
          <Skull className="absolute top-[50%] left-[40%] w-14 h-14 text-purple-500 animate-bounce1" style={{animationDelay: '7s'}} />
          <Flame className="absolute top-[80%] right-[45%] w-12 h-12 text-red-500 animate-bounce2" style={{animationDelay: '2.5s'}} />
          <Skull className="absolute bottom-[70%] left-[35%] w-16 h-16 text-orange-500 animate-bounce3" style={{animationDelay: '4.5s'}} />
          <Flame className="absolute top-[35%] left-[50%] w-14 h-14 text-purple-500 animate-bounce4" style={{animationDelay: '3.5s'}} />
          <Skull className="absolute bottom-[45%] right-[25%] w-18 h-18 text-red-500 animate-bounce5" style={{animationDelay: '5.5s'}} />
          <Flame className="absolute top-[55%] left-[8%] w-10 h-10 text-orange-500 animate-bounce6" style={{animationDelay: '1.5s'}} />
          <Skull className="absolute bottom-[55%] right-[50%] w-14 h-14 text-purple-500 animate-bounce1" style={{animationDelay: '6.5s'}} />
          <Flame className="absolute top-[90%] left-[45%] w-12 h-12 text-red-500 animate-bounce2" style={{animationDelay: '8s'}} />
        </div>
